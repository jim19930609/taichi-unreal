...
inline Version get_version() {
  return Version(CALL_C_API_FUNC(ti_get_version)());
}

inline std::vector<TiArch> get_available_archs() {
  uint32_t narch = 0;
  CALL_C_API_FUNC(ti_get_available_archs)(&narch, nullptr);
  std::vector<TiArch> archs(narch);
  CALL_C_API_FUNC(ti_get_available_archs)(&narch, archs.data());
  return archs;
}
inline std::vector<TiArch> get_available_archs(
...
inline Error get_last_error() {
  ...
  CALL_C_API_FUNC(ti_get_last_error)(&message_size, nullptr);
  std::string message(message_size, '\0');
  TiError error = CALL_C_API_FUNC(ti_get_last_error)(&message_size, (char *)message.data());
...
inline void set_last_error(TiError error) {
  CALL_C_API_FUNC(ti_set_last_error)(error, nullptr);
}
inline void set_last_error(TiError error, const std::string &message) {
  CALL_C_API_FUNC(ti_set_last_error)(error, message.c_str());
}
 ...
 public:
  ...
  inline void copy_to(const MemorySlice &dst) const {
    if (runtime_ != dst.runtime_) {
      CALL_C_API_FUNC(ti_set_last_error)(
    ...
    CALL_C_API_FUNC(ti_copy_memory_device_to_device)(runtime_, &dst.slice_, &slice_);
  }
...
class Memory {
 ...
 public:
  ...
  inline void destroy() {
    if (should_destroy_) {
      CALL_C_API_FUNC(ti_free_memory)(runtime_, memory_);
  ...
  void *map() const {
    return CALL_C_API_FUNC(ti_map_memory)(runtime_, memory_);
  }
  void unmap() const {
    CALL_C_API_FUNC(ti_unmap_memory)(runtime_, memory_);
  }
  ...
  inline MemorySlice slice(size_t offset, size_t size) const {
    if (offset + size > size_) {
      CALL_C_API_FUNC(ti_set_last_error)(TI_ERROR_ARGUMENT_OUT_OF_RANGE, "size");
      return {};
    }
    TiMemorySlice slice{};
 ...
 public:
  ...
  NdArray(Memory &&memory, const TiNdArray &ndarray)
    ...
    if (ndarray.memory != memory_) {
      CALL_C_API_FUNC(ti_set_last_error)(TI_ERROR_INVALID_ARGUMENT, "ndarray.memory != memory");
    }
...
class ImageSlice {
 ...
 public:
  ...
  inline void copy_to(const ImageSlice &dst) const {
    ...
    CALL_C_API_FUNC(ti_copy_image_device_to_device)(runtime_, &dst.slice_, &slice_);
  }
...
class Image {
 ...
 public:
  ...
  inline void destroy() {
    if (should_destroy_) {
      CALL_C_API_FUNC(ti_free_image)(runtime_, image_);
  ...
  inline void transition_to(TiImageLayout layout) const {
    CALL_C_API_FUNC(ti_transition_image)(runtime_, image_, layout);
  }
  ...
  inline ImageSlice slice(const TiImageOffset &offset,
    ...
    if (offset.x + extent.width > extent_.width ||
      ...
      CALL_C_API_FUNC(ti_set_last_error)(TI_ERROR_ARGUMENT_OUT_OF_RANGE, "extent");
      return {};
    }
    TiImageSlice slice{};
    slice.image = image_;
 ...
 public:
  ...
  Texture(Image &&image, const TiTexture &texture)
    ...
    if (texture.image != image_.image()) {
      CALL_C_API_FUNC(ti_set_last_error)(TI_ERROR_INVALID_ARGUMENT, "texture.image != image");
    }
  }
  ~Texture() {
    destroy();
...
class ComputeGraph {
 ...
 public:
  ...
  void launch(uint32_t argument_count, const TiNamedArgument *arguments) const {
    CALL_C_API_FUNC(ti_launch_compute_graph)(runtime_, compute_graph_, argument_count,
                            arguments);
  }
  void launch() const {
...
class Kernel {
 ...
 public:
  ...
  void launch(uint32_t argument_count, const TiArgument *arguments) const {
    CALL_C_API_FUNC(ti_launch_kernel)(runtime_, kernel_, argument_count, arguments);
  }
  void launch() const {
    launch(args_.size(), args_.data());
  }
...
class AotModule {
 ...
 public:
  ...
  inline void destroy() {
    if (should_destroy_) {
      CALL_C_API_FUNC(ti_destroy_aot_module)(aot_module_);
  ...
  Kernel get_kernel(const char *name) const {
    TiKernel kernel_ = CALL_C_API_FUNC(ti_get_aot_module_kernel)(aot_module_, name);
    return Kernel(runtime_, kernel_);
  }
  ComputeGraph get_compute_graph(const char *name) const {
    TiComputeGraph compute_graph_ =
        CALL_C_API_FUNC(ti_get_aot_module_compute_graph)(aot_module_, name);
  ...
  Self &spirv_version(uint32_t major, uint32_t minor) {
    if (major == 1) {
      if (minor == 3) {
        ...
        CALL_C_API_FUNC(ti_set_last_error)(TI_ERROR_ARGUMENT_OUT_OF_RANGE, "minor");
      }
    } else {
      CALL_C_API_FUNC(ti_set_last_error)(TI_ERROR_ARGUMENT_OUT_OF_RANGE, "major");
    }
    return *this;
  }
...
class Runtime {
 ...
 public:
  ...
  inline void destroy() {
    if (should_destroy_) {
      CALL_C_API_FUNC(ti_destroy_runtime)(runtime_);
  ...
  explicit Runtime(TiArch arch, uint32_t device_index = 0)
      : arch_(arch),
        runtime_(CALL_C_API_FUNC(ti_create_runtime)(arch, device_index)),
  ...
  void set_capabilities_ext(
    ...
    CALL_C_API_FUNC(ti_set_runtime_capabilities_ext)(runtime_, (uint32_t)capabilities.size(),
                                    capabilities.data());
  }
  ...
  CapabilityLevelConfig get_capabilities() const {
    uint32_t n = 0;
    CALL_C_API_FUNC(ti_get_runtime_capabilities)(runtime_, &n, nullptr);
    std::vector<TiCapabilityLevelInfo> devcaps(n);
    CALL_C_API_FUNC(ti_get_runtime_capabilities)(runtime_, &n, devcaps.data());
    return CapabilityLevelConfig{std::move(devcaps)};
  }

  Memory allocate_memory(const TiMemoryAllocateInfo &allocate_info) const {
    TiMemory memory = CALL_C_API_FUNC(ti_allocate_memory)(runtime_, &allocate_info);
  ...
  Image allocate_image(const TiImageAllocateInfo &allocate_info) const {
    TiImage image = CALL_C_API_FUNC(ti_allocate_image)(runtime_, &allocate_info);
  ...
  AotModule load_aot_module(const char *path) const {
    TiAotModule aot_module_ = CALL_C_API_FUNC(ti_load_aot_module)(runtime_, path);
  ...
  AotModule create_aot_module(const void *tcm, size_t size) const {
    TiAotModule aot_module = CALL_C_API_FUNC(ti_create_aot_module)(runtime_, tcm, size);
  ...
  void copy_memory_device_to_device(const MemorySlice &dst_memory,
    ...
    CALL_C_API_FUNC(ti_copy_memory_device_to_device)(runtime_, &dst_memory.slice(),
                                    &src_memory.slice());
  }
  void copy_image_device_to_device(const ImageSlice &dst_image,
                                   const ImageSlice &src_image) const {
    CALL_C_API_FUNC(ti_copy_image_device_to_device)(runtime_, &dst_image.slice(),
                                   &src_image.slice());
  }
  void transition_image(TiImage image, TiImageLayout layout) const {
    CALL_C_API_FUNC(ti_transition_image)(runtime_, image, layout);
  }

  void flush() const {
    CALL_C_API_FUNC(ti_flush)(runtime_);
  }
  void wait() const {
    CALL_C_API_FUNC(ti_wait)(runtime_);
  }
