...
if __name__ == "__main__":
    file_path = 'TaichiAOTPlugin/Plugins/AOTPlugin/Source/AOTPlugin/Public/C_API_LINUX/include/taichi/cpp/taichi.hpp'
    new_file_path = 'TaichiAOTPlugin/Plugins/AOTPlugin/Source/AOTPlugin/Public/taichi_unreal.hpp'
